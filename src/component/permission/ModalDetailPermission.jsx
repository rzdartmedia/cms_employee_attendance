...
const ModalDetailPermission = (props) => {
  const attachment = props.permissionId.attachment
    ? props.permissionId.attachment
    : []
  function closeModal() {
    props.setPermissionId({})
            ...
            <div className='max-w-lg m-auto space-y-3 my-4 text-sm'>
              <div>
                ...
                <input
                  ...
                  type='text'
                  value={props.permissionId.name ? props.permissionId.name : ""}
                  readOnly
                />
              </div>
              <div>
                ...
                <input
                  ...
                  type='text'
                  value={
                    props.permissionId.startPermitDate
                      ? props.permissionId.startPermitDate
                      : ""
                  }
                  readOnly
              ...
              <div>
                ...
                <input
                  ...
                  type='text'
                  value={
                    props.permissionId.endPermitDate
                      ? props.permissionId.endPermitDate
                      : ""
                  }
                  readOnly
              ...
              <div>
                ...
                <input
                  ...
                  type='text'
                  value={
                    props.permissionId.lengthPermitDay
                      ? props.permissionId.lengthPermitDay
                      : ""
                  }
                  readOnly
              ...
              <div>
                ...
                <input
                  ...
                  type='text'
                  value={
                    props.permissionId.categoryPermission
                      ? props.permissionId.categoryPermission
                      : ""
                  }
                  readOnly
              ...
              <div>
                ...
                <textarea
                  ...
                  cols='3'
                  value={
                    props.permissionId.informationPermission
                      ? props.permissionId.informationPermission
                      : ""
                  }
                  readOnly
              ...
              <div>
                ...
                <input
                  ...
                  type='text'
                  value={
                    props.permissionId.statusApproval
                      ? props.permissionId.statusApproval
                      : ""
                  }
                  readOnly
              ...
              <div>
                ...
                <textarea
                  ...
                  cols='3'
                  value={
                    props.permissionId.informationApproval
                      ? props.permissionId.informationApproval
                      : ""
                  }
                  readOnly

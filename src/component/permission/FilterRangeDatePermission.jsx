...
const FilterRangeDatePermission = (props) => {
      ...
      <form
        ...
        <div>
          <label
            ...
            htmlFor='startDateFilterPermission'>
            Start Date
          </label>
          <input
        ...
        <div>
          <label
            className='block text-gray-700 text-sm font-bold mb-1 dark:text-gray-300'
            htmlFor='endDateFilterPermission'>
            Till Date
          </label>
          <input
            className={`shadow appearance-none border ${
...
export default FilterRangeDatePermission
